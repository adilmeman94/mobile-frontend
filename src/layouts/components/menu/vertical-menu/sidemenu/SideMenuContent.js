        ...
        <li
          className={classnames("nav-item", {
            ...
            active:
              ...
              history.location.pathname.startsWith(item.startsWith),
...
const mapDispatchToProps = (dispatch) => {
  return {
    purgeAuth: () => dispatch({ type: "PURGE_AUTH" }),
  };
};

export default connect(mapDispatchToProps)(SideMenuContent);
